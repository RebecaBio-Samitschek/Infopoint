...
import "./SecaoAgenda.css";

const SecaoAgenda = ({ dados, atualizarDados, modoVisualizacao = false }) => {
    ...
    <div className={`secao-edicao secao-texto-imagem ${modoVisualizacao ? "modo-visualizacao" : ""}`}>
      <div className="overlay">
        <h2
          ...
          onClick={abrirEditor}
        >
          {dados.titulo || "Confira nossa agenda de eventos"}
        </h2>
        ...
        {!modoVisualizacao && (
          <input
            ...
            placeholder="Cole aqui o link de incorporação do Google Agenda..."
            value={dados.link || ""}
            onChange={(e) =>
      ...
      <div className="agenda-container">
        {dados.link ? (
          ...
          <div className="agenda-placeholder">
            A agenda será exibida aqui após colar o link do Google Agenda.
          </div>
        )}
      </div>
